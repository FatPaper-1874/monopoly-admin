...
import chanceCardListCard from "@/components/sample/chance-card-list-card.vue";
...
const handleChanceCardDelete = async () => {
	...
	<div class="chance-card-page">
		<el-row class="top-bar">
			...
			<el-col :span="4" class="button-container">
				<el-button class="button-create-map" type="primary" @click="handleChanceCardCreate">创建机会卡</el-button>
			</el-col>
		</el-row>
