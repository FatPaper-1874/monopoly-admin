...
let modelPreviewer: ModelPreviewer | undefined;
...
<template>
	<Transition name="item-type-selector-fade">
		<div class="item-type-selector" v-if="visible">
			<div class="form">
				<el-select value-key="color" @change="handleTypeSelect" clearable v-model="currentType" placeholder="选择类型进入添加模式">
