...
<template>
  <div class="street-add">
    <el-form label-position="top" label-width="100px" ref="streetFormRef" :rules="streetFormRules"
      :model="newStreetForm" size="small">
      ...
      <el-form-item label="过路费增值" prop="name">
        ...
        <el-button style="margin-left: 10px;" @click="handleCreateStreet(streetFormRef)" type="primary">添加街道</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
